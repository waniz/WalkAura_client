...
func _ready() -> void:
	...
	log_output.add_theme_font_override("normal_font", font)
	log_output.add_theme_font_size_override("normal_font_size", 14)
	# Colors & outline
	log_output.add_theme_color_override("default_color", Color.from_rgba8(220, 220, 220))
	log_output.add_theme_color_override("font_outline_color", Color(0, 0, 0, 0.75))
	log_output.add_theme_constant_override("outline_size", 2)
