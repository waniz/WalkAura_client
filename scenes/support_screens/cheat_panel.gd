...
@onready var cheat_100_button: Button = $PanelContainer/HBoxContainer/Cheat_100_button
@onready var cheat_1000_button: Button = $PanelContainer/HBoxContainer/Cheat_1000_button
@onready var cheat_10000_button: Button = $PanelContainer/HBoxContainer/Cheat_10000_button
@onready var pedometer_plugin_button: Button = $PanelContainer/HBoxContainer/PedometerPluginButton
...
func _ready() -> void:
	...
	Styler.style_panel_no_margins(panel, Color.from_rgba8(16,18,24,220), Color.from_rgba8(255,255,255,30))
